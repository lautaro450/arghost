        ...
        <div class="col-md-9 pull-md-right">
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="loginemail" id="inputLoginEmail" class="iw-txt" placeholder="{$LANG.orderForm.emailAddress}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="firstname" id="inputFirstName" class="iw-txt" placeholder="{$LANG.orderForm.firstName}" value="{$clientsdetails.firstname}"{if $loggedin} readonly="readonly"{/if} autofocus>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="lastname" id="inputLastName" class="iw-txt" placeholder="{$LANG.orderForm.lastName}" value="{$clientsdetails.lastname}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="email" name="email" id="inputEmail" class="iw-txt" placeholder="{$LANG.orderForm.emailAddress}" value="{$clientsdetails.email}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="tel" name="phonenumber" id="inputPhone" class="iw-txt" placeholder="{$LANG.orderForm.phoneNumber}" value="{$clientsdetails.phonenumber}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="companyname" id="inputCompanyName" class="iw-txt" placeholder="{$LANG.orderForm.companyName} ({$LANG.orderForm.optional})" value="{$clientsdetails.companyname}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="address1" id="inputAddress1" class="iw-txt" placeholder="{$LANG.orderForm.streetAddress}" value="{$clientsdetails.address1}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="address2" id="inputAddress2" class="iw-txt" placeholder="{$LANG.orderForm.streetAddress2}" value="{$clientsdetails.address2}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="city" id="inputCity" class="iw-txt" placeholder="{$LANG.orderForm.city}" value="{$clientsdetails.city}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-5">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="postcode" id="inputPostcode" class="iw-txt" placeholder="{$LANG.orderForm.postcode}" value="{$clientsdetails.postcode}"{if $loggedin} readonly="readonly"{/if}>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                    ...
                    <div class="row{if $contact neq "addingnew"} hidden{/if}" id="domainRegistrantInputFields">
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactfirstname" id="inputDCFirstName" class="iw-txt" placeholder="{$LANG.orderForm.firstName}" value="{$domaincontact.firstname}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactlastname" id="inputDCLastName" class="iw-txt" placeholder="{$LANG.orderForm.lastName}" value="{$domaincontact.lastname}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="email" name="domaincontactemail" id="inputDCEmail" class="iw-txt" placeholder="{$LANG.orderForm.emailAddress}" value="{$domaincontact.email}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="tel" name="domaincontactphonenumber" id="inputDCPhone" class="iw-txt" placeholder="{$LANG.orderForm.phoneNumber}" value="{$domaincontact.phonenumber}">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactcompanyname" id="inputDCCompanyName" class="iw-txt" placeholder="{$LANG.orderForm.companyName} ({$LANG.orderForm.optional})" value="{$domaincontact.companyname}">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactaddress1" id="inputDCAddress1" class="iw-txt" placeholder="{$LANG.orderForm.streetAddress}" value="{$domaincontact.address1}">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactaddress2" id="inputDCAddress2" class="iw-txt" placeholder="{$LANG.orderForm.streetAddress2}" value="{$domaincontact.address2}">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactcity" id="inputDCCity" class="iw-txt" placeholder="{$LANG.orderForm.city}" value="{$domaincontact.city}">
                            </div>
                        </div>
                        <div class="col-sm-5">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactstate" id="inputDCState" class="iw-txt" placeholder="{$LANG.orderForm.state}" value="{$domaincontact.state}">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="text" name="domaincontactpostcode" id="inputDCPostcode" class="iw-txt" placeholder="{$LANG.orderForm.postcode}" value="{$domaincontact.postcode}">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                        ...
                        {if $showccissuestart}
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="tel" name="ccstartdate" id="inputCardStart" class="iw-txt" placeholder="MM / YY ({$LANG.creditcardcardstart})" autocomplete="cc-exp">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group prepend-icon">
                                    ...
                                    <input type="tel" name="ccissuenum" id="inputCardIssue" class="iw-txt" placeholder="{$LANG.creditcardcardissuenum}">
                                </div>
                            </div>
                        {/if}
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="tel" name="ccexpirydate" id="inputCardExpiry" class="iw-txt" placeholder="MM / YY{if $showccissuestart} ({$LANG.creditcardcardexpires}){/if}" autocomplete="cc-exp">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="tel" name="cccvv" id="inputCardCVV" class="iw-txt" placeholder="{$LANG.orderForm.cvv}" autocomplete="cc-cvc">
                            </div>
                        </div>
                    </div>
                    <div id="existingCardInfo" class="row{if !$clientsdetails.cclastfour || $ccinfo eq "new"} hidden{/if}">
                        <div class="col-sm-12">
                            <div class="form-group prepend-icon">
                                ...
                                <input type="tel" name="cccvvexisting" id="inputCardCVV" class="iw-txt" placeholder="{$LANG.orderForm.cvv}" autocomplete="cc-cvc">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <button type="submit" id="btnCompleteOrder" class="iw-btn iw-btn-default iw-btn-large"{if $cartitems==0} disabled="disabled"{/if} onclick="this.value='{$LANG.pleasewait}'">
                        {$LANG.completeorder}
