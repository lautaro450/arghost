        ...
        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="{if $showqtyoptions}col-sm-5{else}col-sm-7{/if}">
                                                <span class="item-title">
                                                    ...
                                                    <a href="{$smarty.server.PHP_SELF}?a=confproduct&i={$num}" class="btn btn-xs">
                                                        <i class="fa fa-pencil"></i>
                                                        {$LANG.orderForm.edit}
                                                    </a>
                                                    <span class="visible-xs-inline">
                                                        <button type="button" class="btn  btn-xs btn-remove-from-cart" onclick="removeItem('p','{$num}')">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <span class="item-title">
                                                    {$addon.name}
                                                    <span class="visible-xs-inline">
                                                        <button type="button" class="btn  btn-xs btn-remove-from-cart" onclick="removeItem('a','{$num}')">
                                                            <i class="fa fa-times"></i>
                                                            {$LANG.orderForm.remove}
                                                        </button>
                                                    </span>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-7">
                                                <span class="item-title">
                                                    ...
                                                    <a href="{$smarty.server.PHP_SELF}?a=confdomains" class="btn  btn-xs">
                                                        <i class="fa fa-pencil"></i>
                                                        Edit
                                                    </a>
                                                    <span class="visible-xs-inline">
                                                        <button type="button" class="btn  btn-xs btn-remove-from-cart" onclick="removeItem('d','{$num}')">
                                                            <i class="fa fa-times"></i>
                                                            {$LANG.orderForm.remove}
                                                        </button>
                                                    </span>
                                ...
                                {foreach key=num item=domain from=$renewals}
                                    <div class="item">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-1">
                                                <button type="button" class="btn  btn-xs btn-remove-from-cart" onclick="removeItem('r','{$num}')">
                                                    <i class="fa fa-times"></i>
                                ...
                                <div role="tabpanel" class="tab-pane active promo" id="applyPromo">
                                    ...
                                    {else}
                                        <form method="post" action="cart.php?a=view">
                                            ...
                                            <button type="submit" name="validatepromo" class="iw-btn iw-btn-default btn-block" value="{$LANG.orderpromovalidatebutton}">
            ...
            {if $totalrecurringtriennially}{$totalrecurringtriennially} {$LANG.orderpaymenttermtriennially}<br />{/if}
                                ...
                                <div class="text-right viewcart-group-button">
                                    <a href="cart.php?a=checkout" class="iw-btn iw-btn-default iw-btn-large iw-cart-checkout{if $cartitems == 0} disabled{/if}" id="checkout">
