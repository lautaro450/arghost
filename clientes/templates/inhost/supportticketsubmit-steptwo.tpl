        ...
        <div class="group-input submit-input">
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <input type="submit" id="openTicketSubmit" value="{$LANG.supportticketsticketsubmit}" class="iw-btn iw-btn-default iw-btn-large" />
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <a href="supporttickets.php" class="iw-btn iw-btn-black iw-btn-large">{$LANG.cancel}</a>
                </div>
            </div>
        </div>
