...
{foreach from=$announcements item=announcement}
    ...
    <div class="announcement-single">
        ...
        <div class="announcement-title">
            <span>
                {"d/m/Y"|date:$announcement.timestamp}: 
            </span>
        ...
        <!--<a href="{if $seofriendlyurls}{$WEB_ROOT}/announcements/{$announcement.id}/{$announcement.urlfriendlytitle}.html{else}{$smarty.server.PHP_SELF}?id={$announcement.id}{/if}" class="label label-info">{$LANG.readmore} &raquo;</a>-->
            {/if}</p>
        </div>
