        ...
        <form id="frmDomainChecker">
            ...
            <div class="">
                <div class="group-input">
                    ...
                    <div class="group-btn">
                        <button type="submit" id="btnCheckAvailability" class="iw-btn iw-btn-default iw-btn-large">{$LANG.search}</button>
                        {if $bulkdomainsearchenabled}
                            <a href="domainchecker.php?search=bulk" id="btnBulkOptions" class="iw-btn iw-btn-orange iw-btn-large">{$LANG.bulkoptions}</a>
                        {/if}
                    </div>
                </div>
            </div>
...
<div id="pricingTable"{if $performingLookup} class="hidden" {else} class="pricing-domain" {/if}>
