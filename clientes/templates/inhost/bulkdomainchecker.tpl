...
<div class="domain-checker-container bulk-domain-checker">
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="input-group-box">
                        ...
                        <button type="submit" id="btnCheckAvailability" class="iw-btn iw-btn-default iw-btn-large">{$LANG.checkavailability}</button>
                    </div>
                </div>
            </div>
