...
{if !$registrationDisabled}
    ...
    <form method="post" class="using-password-strength" action="{$smarty.server.PHP_SELF}" role="form">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="firstname" id="firstname" value="{$clientfirstname}" class="iw-txt iw-txt-block" {if !in_array('firstname', $optionalFields)}required{/if} />
                </div>

                <div class="form-group">
                    <label for="lastname" class="control-label">{$LANG.clientarealastname}</label>
                    <input type="text" name="lastname" id="lastname" value="{$clientlastname}" class="iw-txt iw-txt-block" {if !in_array('lastname', $optionalFields)}required{/if} />
                </div>

                <div class="form-group">
                    <label for="companyname" class="control-label">{$LANG.clientareacompanyname}</label>
                    <input type="text" name="companyname" id="companyname" value="{$clientcompanyname}" class="iw-txt iw-txt-block"/>
                </div>

                <div class="form-group">
                    <label for="email" class="control-label">{$LANG.clientareaemail}</label>
                    <input type="email" name="email" id="email" value="{$clientemail}" class="iw-txt iw-txt-block"/>
                </div>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address1" id="address1" value="{$clientaddress1}" class="iw-txt iw-txt-block" {if !in_array('address1', $optionalFields)}required{/if} />
                </div>

                <div class="form-group">
                    <label for="address2" class="control-label">{$LANG.clientareaaddress2}</label>
                    <input type="text" name="address2" id="address2" value="{$clientaddress2}" class="iw-txt iw-txt-block"/>
                </div>

                <div class="form-group">
                    <label for="city" class="control-label">{$LANG.clientareacity}</label>
                    <input type="text" name="city" id="city" value="{$clientcity}" class="iw-txt iw-txt-block" {if !in_array('city', $optionalFields)}required{/if} />
                </div>

                <div class="form-group">
                    <label for="state" class="control-label">{$LANG.clientareastate}</label>
                    <input type="text" name="state" id="state" value="{$clientstate}" class="iw-txt-block" {if !in_array('state', $optionalFields)}required{/if} />
                </div>

                <div class="form-group">
                    <label for="postcode" class="control-label">{$LANG.clientareapostcode}</label>
                    <input type="text" name="postcode" id="postcode" value="{$clientpostcode}" class="iw-txt iw-txt-block" {if !in_array('postcode', $optionalFields)}required{/if} />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phonenumber" id="phonenumber" value="{$clientphonenumber}" class="iw-txt iw-txt-block" {if !in_array('phonenumber', $optionalFields)}required{/if} />
                </div>
        ...
        <div class="group-btn">
            <input class="iw-btn iw-btn-large iw-btn-default" type="submit" value="{$LANG.clientregistertitle}"/>
        </div>
