        ...
        <div class="domainresults" id="primarySearchResults">
            ...
            <table class="table table-curved table-hover" id="searchResults">
                <tbody>
                    {if $searchResults}
                        <tr>
                            <td class="search-result-domain-name"><strong>{$searchResults.domainName}</strong></td>
    ...
    <div class="search-domain-suggestion">
        <div class="">
            ...
            {if $moreSuggestionsAvailable}
                <p class="text-center">
                    <a href="#" class="" id="btnMoreSuggestions" onclick="showMoreSuggestions();return false">{$LANG.domainsmoresuggestions}</a>
                </p>
            {/if}
