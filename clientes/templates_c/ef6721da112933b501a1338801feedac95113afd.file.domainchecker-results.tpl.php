<?php /* Smarty version Smarty-3.1.21, created on 2016-08-11 10:45:42
         compiled from "/Applications/MAMP/htdocs/arghost/clientes/templates/inhost/domainchecker-results.tpl" */ ?>
<?php /*%%SmartyHeaderCode:198235559657ac3b36b43222-64043570%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ef6721da112933b501a1338801feedac95113afd' => 
    array (
      0 => '/Applications/MAMP/htdocs/arghost/clientes/templates/inhost/domainchecker-results.tpl',
      1 => 1456860468,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '198235559657ac3b36b43222-64043570',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ac3b36d6fe43_36711698',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ac3b36d6fe43_36711698')) {function content_57ac3b36d6fe43_36711698($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['validDomain']->value) {?>
 ...
 &raquo;</a>
            ...
            <table class="table table-curved table-hover" id="searchResults">
                <tbody>
                    <?php if ($_smarty_tpl->tpl_vars['searchResults']->value) {?>
                        <tr>
                            <td class="search-result-domain-name"><strong><?php echo $_smarty_tpl->tpl_vars['searchResults']->value['domainName'];?>
</strong></td>
                            ...
                            <td class="text-center">
                                <?php if (count($_smarty_tpl->tpl_vars['searchResults']->value['pricing'])==1) {?>
                                    <button type="button" onclick="addToCart(this, false, 'register')" class="iw-btn iw-btn-default">
...
?>
                        <tr>
                            <td><?php echo $_smarty_tpl->tpl_vars['result']->value['domainName'];?>
</td>
                            <td class="text-center">
                            ...
                            <td class="text-right">
                                <?php if (($_smarty_tpl->tpl_vars['searchingFor']->value=='register'&&$_smarty_tpl->tpl_vars['result']->value['isAvailable'])) {?>
                                    ...
                                    <?php } else { ?>
                                        <div class="btn-group">
                                            <button type="button" class="iw-btn iw-btn-default" onclick="addToCart(this, false, 'register')">
                                                <b class="glyphicon glyphicon-shopping-cart"></b>
                                                <?php echo $_smarty_tpl->tpl_vars['LANG']->value['addtocart'];?>
...
<?php if ($_smarty_tpl->tpl_vars['searchResults']->value&&count($_smarty_tpl->tpl_vars['searchResults']->value['suggestions'])>0) {?>
    <div class="search-domain-suggestion">
        <div class="">
...
?>
                            <tr<?php if ($_smarty_tpl->tpl_vars['i']->value>=10) {?> class="hidden"<?php }?>>
                                <td class="search-result-domain-name">
...
?>
 ...
 @ <?php echo $_smarty_tpl->tpl_vars['price']->value['register'];?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['moreSuggestionsAvailable']->value) {?>
                <p class="text-center">
                    <a href="#" class="" id="btnMoreSuggestions" onclick="showMoreSuggestions();return false"><?php echo $_smarty_tpl->tpl_vars['LANG']->value['domainsmoresuggestions'];?>
</a>
                </p>
            <?php }?>
