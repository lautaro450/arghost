<?php /* Smarty version Smarty-3.1.21, created on 2016-08-11 10:01:17
         compiled from "/Applications/MAMP/htdocs/arghost/clientes/admin/templates/blend/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:201157736457ac30cd076ae3-55154906%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75726efda8311203730020c458e722b138595545' => 
    array (
      0 => '/Applications/MAMP/htdocs/arghost/clientes/admin/templates/blend/menu.tpl',
      1 => 1460406838,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '201157736457ac30cd076ae3-55154906',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ac30cd5e1476_16975288',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ac30cd5e1476_16975288')) {function content_57ac30cd5e1476_16975288($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/Applications/MAMP/htdocs/arghost/clientes/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
?><div class="navigation">
<ul id="menu">
<li><a id="Menu-Clients" <?php if (in_array("List Clients",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="clients.php"<?php }?> title="Clients"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['clients']['title'];?>
</a>
  <ul>
...
<li><a id="Menu-Support" <?php if (in_array("Support Center Overview",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?>href="supportcenter.php"<?php }?> title="Support"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['support']['title'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['menuticketstatuses']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<li><a id="Menu-Utilities" title="Utilities" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['title'];?>
  ...
  <ul>
    ...
    <?php if (in_array("Browser",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Utilities-Browser" href="browser.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['browser'];?>
</a></li><?php }?>
...
<li><a id="Menu-Addons" title="Addons" href="addonmodules.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['addonmodules'];?>
  ...
  <ul>
    <?php  $_smarty_tpl->tpl_vars['displayname'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['displayname']->_loop = false;
...
foreach ($_from as $_smarty_tpl->tpl_vars['displayname']->key => $_smarty_tpl->tpl_vars['displayname']->value) {
$_smarty_tpl->tpl_vars['displayname']->_loop = true;
 $_smarty_tpl->tpl_vars['module']->value = $_smarty_tpl->tpl_vars['displayname']->key;
?>
...
?>
    <li><a id="Menu-Addons-Addons_Directory" href="addonmodules.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['utilities']['addonsdirectory'];?>
</a></li>
    <?php } ?>
  </ul>
</li>
...
<li><a id="Menu-Help" title="Help" href=""><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['title'];?>
  ...
  <ul>
    ...
    <?php if (in_array("Configure Administrators",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Help-Change_License_Key" href="licenseerror.php?licenseerror=change"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['changelicense'];?>
      ...
      <?php }?>
    <?php if (in_array("Configure General Settings",$_smarty_tpl->tpl_vars['admin_perms']->value)) {?><li><a id="Menu-Help-Get_Help" href="systemsupportrequest.php"><?php echo $_smarty_tpl->tpl_vars['_ADMINLANG']->value['help']['support'];?>
</a></li><?php }?>
