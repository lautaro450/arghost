...
// GENERAL SETTING
        ...
        $of_options[] = array("name" => "Retina support:",
            ...
            "std" => 0,
            "type" => "checkbox");
		$of_options[] = array("name" => "Google API",
            "desc" => 'Use for process data from google service. Eg: map, photo, video... To get Google api, you can access via <a href="https://console.developers.google.com/" target="_blank">here</a>.',
            "id" => "google_api",
            "std" => '',
            "type" => "text");
