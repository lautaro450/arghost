...
<div class="wrap">
	...
	<form class="wg-widget-option-form" method="post" action="options.php">
		...
		<table class="form-table">
			...
			<td><input type="text" name="destination_l" value="<?php echo esc_attr( get_option('destination_l') ); ?>" placeholder="en,es" required /><?php if($this->userInfo['plan']<=0) { ?><p class="wg-fsubtext"><?php _e( 'On the free plan, you can only chose one language with a maximum of 2000 words. If you want to use more than 1 language and 2000 words, please <a target="_blank" href="https://weglot.com/change-plan">upgrade your plan</a>.', 'weglot' ); ?></p><?php } ?></td>
			</tr>
		</table>	
...
text-align :right;
	...
	<br><br>
	<i class="fa fa-question-circle" aria-hidden="true" style="font-size : 17px;"></i><p style="display:inline-block; margin-left:5px;"><?php _e('If you need any help, you can contact us on our live chat on <a href="https://weglot.com/" target="_blank">weglot.com</a> or email us at contact@weglot.com','weglot'); ?></p>
	<br><br><br>
	<h2></h2>
</div>