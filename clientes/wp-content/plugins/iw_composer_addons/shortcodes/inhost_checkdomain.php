...
//                    $iwConfig['whmcs_morelink_page'] = $this->getWhmcsLink('domainchecker');
                ...
                public function getWhmcsLink($page, $action = '') {
                    ...
                    }elseif ((is_plugin_active('WHMCS_Client_Area/index.php') || is_plugin_active('WHMpress_Client_Area/client-area.php')) && $whmp_page_id) {
                        $link = get_the_permalink($whmp_page_id);
                        if ($this->check_permarklink($link)) {
                            $link.= '&whmpca=' . $page;
                        } else {
                            $link.= '?whmpca=' . $page;
