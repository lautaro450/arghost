...
if (!class_exists('Athlete_Map')) {
    ...
    class Athlete_Map {
        ...
        function athlete_map_scripts() {
            ...
            wp_register_script('google-maps', 'https://maps.googleapis.com/maps/api/js'. (isset($smof_data['google_api']) ? '?key=' . $smof_data['google_api'] : ''), array('jquery'), $theme_info->get('Version'));
