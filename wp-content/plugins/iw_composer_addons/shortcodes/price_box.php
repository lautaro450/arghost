...
if (!class_exists('Inwave_Price_Box')) {
    ...
    class Inwave_Price_Box {
            ...
            $this->params = array(
                ...
                'params' => array(
                    ...
                    array(
                        ...
                        "param_name" => "price",
						"description"=> "Example: $7.9/month"
                    ),
					array(
                        "type" => "textfield",
                        "heading" => __("Old Price", "inwavethemes"),
                        "param_name" => "old_price",
						"description"=> "Example: $9.9/month"
                    ),
                    array(
                        "type" => "textfield",
        ...
        function inwave_price_box_shortcode($atts, $content = null) {
            ...
            $output = $img = $title = $sub_title = $class = $style = $icon_size = $purchase_text = $purchase_link = $price = $old_price = $price_desc = $icon = $featured = $trial_day = '';
            extract(shortcode_atts(array(
                'img' => '',
                'icon' => '',
                'icon_size' => '36px',
