...
<div class="cart-total">
    <div class="title"><?php _e( 'Cart Totals', 'woocommerce' ); ?></div>
	...
	<div class="wc-proceed-to-checkout">
        ...
        <a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="checkout-button button alt wc-forward"><em class="fa-icon"><i class="fa fa-arrow-right"></i></em><?php _e( 'Proceed to Checkout', 'woocommerce' ); ?></a>
